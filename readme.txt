...
There are several dependencies not you'll have to track down to compile this
(ARM stuff, tools for formatting the compiled code into a GBA rom, etc). Check
the makefile for details, and also refer to Tonc (located at
